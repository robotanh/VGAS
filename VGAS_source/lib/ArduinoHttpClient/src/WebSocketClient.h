...
class WebSocketClient : public MyClient
{
public:
    WebSocketClient(Client& aClient, const char* aServerName, uint16_t aServerPort = MyClient::kHttpPort);
    WebSocketClient(Client& aClient, const String& aServerName, uint16_t aServerPort = MyClient::kHttpPort);
    WebSocketClient(Client& aClient, const IPAddress& aServerAddress, uint16_t aServerPort = MyClient::kHttpPort);
