...
const char* MyClient::kUserAgent = "Arduino/2.2.0";
const char* MyClient::kContentLengthPrefix = HTTP_HEADER_CONTENT_LENGTH ": ";
const char* MyClient::kTransferEncodingChunked = HTTP_HEADER_TRANSFER_ENCODING ": " HTTP_HEADER_VALUE_CHUNKED;

MyClient::MyClient(Client& aClient, const char* aServerName, uint16_t aServerPort)
...
MyClient::MyClient(Client& aClient, const String& aServerName, uint16_t aServerPort)
 : MyClient(aClient, aServerName.c_str(), aServerPort)
{
}

MyClient::MyClient(Client& aClient, const IPAddress& aServerAddress, uint16_t aServerPort)
...
void MyClient::connectionKeepAlive()
{
  iConnectionClose = false;
}

void MyClient::noDefaultRequestHeaders()
{
  iSendDefaultRequestHeaders = false;
}

void MyClient::beginRequest()
{
  iState = eRequestStarted;
}

int MyClient::startRequest(const char* aURLPath, const char* aHttpMethod, 
...
int MyClient::sendInitialHeaders(const char* aURLPath, const char* aHttpMethod)
{
#ifdef LOGGING
...
void MyClient::sendHeader(const char* aHeader)
{
    iClient->println(aHeader);
}

void MyClient::sendHeader(const char* aHeaderName, const char* aHeaderValue)
{
...
void MyClient::sendHeader(const char* aHeaderName, const int aHeaderValue)
{
    iClient->print(aHeaderName);
    iClient->print(": ");
    iClient->println(aHeaderValue);
...
void MyClient::sendBasicAuth(const char* aUser, const char* aPassword)
{
...
void MyClient::finishHeaders()
{
    iClient->println();
    iState = eRequestSent;
}

void MyClient::flushClientRx()
{
...
void MyClient::endRequest()
{
    beginBody();
}

void MyClient::beginBody()
{
...
int MyClient::get(const char* aURLPath)
{
    return startRequest(aURLPath, HTTP_METHOD_GET);
}

int MyClient::get(const String& aURLPath)
{
    return get(aURLPath.c_str());
}

int MyClient::post(const char* aURLPath)
{
    return startRequest(aURLPath, HTTP_METHOD_POST);
}

int MyClient::post(const String& aURLPath)
{
    return post(aURLPath.c_str());
}

int MyClient::post(const char* aURLPath, const char* aContentType, const char* aBody)
{
    return post(aURLPath, aContentType, strlen(aBody), (const byte*)aBody);
}

int MyClient::post(const String& aURLPath, const String& aContentType, const String& aBody)
{
    return post(aURLPath.c_str(), aContentType.c_str(), aBody.length(), (const byte*)aBody.c_str());
}

int MyClient::post(const char* aURLPath, const char* aContentType, int aContentLength, const byte aBody[])
{
    return startRequest(aURLPath, HTTP_METHOD_POST, aContentType, aContentLength, aBody);
}

int MyClient::put(const char* aURLPath)
{
    return startRequest(aURLPath, HTTP_METHOD_PUT);
}

int MyClient::put(const String& aURLPath)
{
    return put(aURLPath.c_str());
}

int MyClient::put(const char* aURLPath, const char* aContentType, const char* aBody)
{
    return put(aURLPath, aContentType, strlen(aBody),  (const byte*)aBody);
}

int MyClient::put(const String& aURLPath, const String& aContentType, const String& aBody)
{
    return put(aURLPath.c_str(), aContentType.c_str(), aBody.length(), (const byte*)aBody.c_str());
}

int MyClient::put(const char* aURLPath, const char* aContentType, int aContentLength, const byte aBody[])
{
    return startRequest(aURLPath, HTTP_METHOD_PUT, aContentType, aContentLength, aBody);
}

int MyClient::patch(const char* aURLPath)
{
    return startRequest(aURLPath, HTTP_METHOD_PATCH);
}

int MyClient::patch(const String& aURLPath)
{
    return patch(aURLPath.c_str());
}

int MyClient::patch(const char* aURLPath, const char* aContentType, const char* aBody)
{
    return patch(aURLPath, aContentType, strlen(aBody),  (const byte*)aBody);
}

int MyClient::patch(const String& aURLPath, const String& aContentType, const String& aBody)
{
    return patch(aURLPath.c_str(), aContentType.c_str(), aBody.length(), (const byte*)aBody.c_str());
}

int MyClient::patch(const char* aURLPath, const char* aContentType, int aContentLength, const byte aBody[])
{
    return startRequest(aURLPath, HTTP_METHOD_PATCH, aContentType, aContentLength, aBody);
}

int MyClient::del(const char* aURLPath)
{
    return startRequest(aURLPath, HTTP_METHOD_DELETE);
}

int MyClient::del(const String& aURLPath)
{
    return del(aURLPath.c_str());
}

int MyClient::del(const char* aURLPath, const char* aContentType, const char* aBody)
{
    return del(aURLPath, aContentType, strlen(aBody),  (const byte*)aBody);
}

int MyClient::del(const String& aURLPath, const String& aContentType, const String& aBody)
{
    return del(aURLPath.c_str(), aContentType.c_str(), aBody.length(), (const byte*)aBody.c_str());
}

int MyClient::del(const char* aURLPath, const char* aContentType, int aContentLength, const byte aBody[])
{
    return startRequest(aURLPath, HTTP_METHOD_DELETE, aContentType, aContentLength, aBody);
}

int MyClient::responseStatusCode()
{
    if (iState < eRequestSent)
    {
        return HTTP_ERROR_API;
...
int MyClient::skipResponseHeaders()
{
...
bool MyClient::endOfBodyReached()
{
...
String MyClient::readHeaderName()
{
...
String MyClient::readHeaderValue()
{
    int colonIndex = iHeaderLine.indexOf(':');
